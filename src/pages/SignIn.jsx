...
export default function SignIn() {
  ...
  return (
    <main className="h-dvh sm:min-h-screen overflow-hidden bg-pastel-bg flex items-center justify-center px-4 sm:px-6 py-0 sm:py-12">
      ...
      `}</style>
      <div className="relative w-full max-w-5xl border border-pastel-border bg-pastel-card px-5 sm:px-12 lg:px-16 py-7 sm:py-12 lg:py-14 overflow-hidden">
        ...
        <div className="relative flex items-center gap-3 mb-6 sm:mb-10 lg:mb-12">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 lg:gap-12 items-start">
          ...
          <section className="md:pr-5 lg:pr-6 text-center">
            <h1 className="font-display text-4xl sm:text-5xl md:text-[3.9rem] lg:text-[4.8rem] font-light text-pastel-ink leading-[0.94] mb-3 sm:mb-4">
              What Do We Read Next?
            </h1>
            <p className="text-xs tracking-[0.25em] uppercase text-pastel-mid mb-5 sm:mb-6">
        ...
        <p className="mt-8 sm:mt-10 text-[11px] tracking-[0.2em] uppercase text-pastel-muted text-center">
